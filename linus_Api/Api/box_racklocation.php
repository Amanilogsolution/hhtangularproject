	...
	if($_SERVER['REQUEST_METHOD'] === "POST")
	{
		...
		if(!empty($rackLocationInputs->wh) && !empty($rackLocationInputs->dnno) && !empty($rackLocationInputs->whlocation)){
			try{
				...
				$rackLocationData = $rackLocationObj->getrackLocation($rackLocationInputs->wh, $rackLocationInputs->dnno, $rackLocationInputs->whlocation,  $records_per_page, $numer_of_records);
