<?php
	...
	if($_SERVER['REQUEST_METHOD'] === "POST"){
		...
		if(!empty($cycleCount->wh) && !empty($cycleCount->aisles) && !empty($cycleCount->Batchid)){
			try{
                ...
                $aislesData = $aislesDataObj->scanAisles($cycleCount->aisles, $cycleCount->Batchid, $records_per_page, $numer_of_records);
				...
				$aislesDataArray["numberOfRecords"]=$aislesDataObj->scanAislesCount($cycleCount->aisles, $cycleCount->Batchid);
